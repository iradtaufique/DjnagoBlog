...
urlpatterns = [
    ...
    # here we removed board_topics and replace it with TopicListView.as_View()
...
#     pk is used to identify the Boards
#     topic_pk is used to identify which topic to retrieve from database
